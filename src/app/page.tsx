...
export default function Page() {
  ...
  <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-7 py-4 text-sm font-medium text-white backdrop-blur-3xl">
    Call
  </span>
</button>
</a>
